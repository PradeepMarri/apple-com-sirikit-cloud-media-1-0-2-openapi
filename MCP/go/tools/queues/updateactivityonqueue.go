...
func UpdateactivityonqueueHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateActivityRequest
		...
		url := fmt.Sprintf("%s/queues/updateActivity", cfg.BaseURL)
		...
		var result models.UpdateActivityResponse
...
func CreateUpdateactivityonqueueTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_queues_updateActivity",
		mcp.WithDescription("updateActivity"),
		...
		mcp.WithObject("nowPlaying", mcp.Description("")),
		mcp.WithObject("previouslyPlaying", mcp.Description("")),
		mcp.WithString("report", mcp.Required(), mcp.Description("")),
		mcp.WithString("timestamp", mcp.Required(), mcp.Description("")),
		mcp.WithObject("userActivity", mcp.Required(), mcp.Description("")),
		mcp.WithString("version", mcp.Required(), mcp.Description("")),
		mcp.WithObject("constraints", mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    UpdateactivityonqueueHandler(cfg),
	}
}
