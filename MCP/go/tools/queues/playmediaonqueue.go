...
func PlaymediaonqueueHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.PlayMediaRequest
		...
		url := fmt.Sprintf("%s/queues/playMedia", cfg.BaseURL)
...
func CreatePlaymediaonqueueTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_queues_playMedia",
		...
		mcp.WithObject("constraints", mcp.Required(), mcp.Description("")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    PlaymediaonqueueHandler(cfg),
	}
}
