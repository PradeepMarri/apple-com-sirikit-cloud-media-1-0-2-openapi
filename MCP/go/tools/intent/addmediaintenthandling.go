...
func AddmediaintenthandlingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody []AddMediaIntentHandlingInvocation
		...
		url := fmt.Sprintf("%s/intent/addMedia", cfg.BaseURL)
...
func CreateAddmediaintenthandlingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_intent_addMedia",
		mcp.WithDescription("addMedia"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    AddmediaintenthandlingHandler(cfg),
	}
}
