...
func UpdatemediaaffinityintenthandlingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody []UpdateMediaAffinityIntentHandlingInvocation
		...
		url := fmt.Sprintf("%s/intent/updateMediaAffinity", cfg.BaseURL)
...
func CreateUpdatemediaaffinityintenthandlingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_intent_updateMediaAffinity",
		mcp.WithDescription("updateMediaAffinity"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdatemediaaffinityintenthandlingHandler(cfg),
	}
}
